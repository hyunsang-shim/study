...
void cUIButton::Render(LPD3DXSPRITE pSprite)
{
	...
	pSprite->Draw(m_aTexture[m_eButtonState], &rc, &D3DXVECTOR3(0, 0, 0), &D3DXVECTOR3(0, 0, 0), D3DCOLOR_RGBA(255, 255, 255, 255));
...
void cUIButton::SetText(string str)
{
	...
	pTextView->Setsize(ST_SIZE_N(m_stSize.nWidth, m_stSize.nHeight));
